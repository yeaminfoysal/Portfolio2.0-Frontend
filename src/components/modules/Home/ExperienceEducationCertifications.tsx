...
export default function ExperienceEducationCertifications() {
    ...
    return (
        <section className="w-full max-w-6xl mx-auto py-16 px-4 relative">
            {/* Glow Effect */}
            ...
            {/* Header */}
            <h2 className="text-center text-3xl md:text-4xl font-bold mb-10 bg-gradient-to-r from-fuchsia-500 to-purple-500 bg-clip-text text-transparent">
                My Journey
            </h2>
            ...
            <div className="flex justify-center gap-6 mb-10">
              ...
              ${activeTab === tab.id
                                ...
                                : "border-purple-800 text-gray-300 hover:text-white hover:border-purple-600"
                            }`}
                    >
                        {tab.icon}
                        <span>{tab.label}</span>
